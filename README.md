...
**Nombre y Apellido:** Valentín Lucero
...
C es un lenguaje **imperativo y estructurado en bloques**, cuyas reglas sintácticas y semánticas están fijadas formalmente por el estándar **ISO/IEC 9899** (conocido informalmente por sus revisiones: C89/C90, C99, C11, C17 y C23), mantenido por el comité **ISO/IEC JTC1/SC22/WG14**. Antes de la estandarización ISO, la referencia de facto fue el libro de Kernighan y Ritchie, *The C Programming Language* (de ahí el término "K&R C").
...
En cambio, C resulta comparativamente más costoso (en tiempo de desarrollo) para problemas de alto nivel como el procesamiento simbólico complejo, la manipulación de estructuras de datos muy dinámicas o el desarrollo rápido de interfaces de usuario, tareas donde lenguajes de niveles más altos (orientados a objetos, funcionales o de script) suelen ser más productivos.
